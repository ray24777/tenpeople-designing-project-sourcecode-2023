...
sensor.set_auto_gain(False) # null
sensor.set_auto_whitebal(False) # null
sensor.set_brightness(2) # null
canny_t = (80, 140) #80 150
...
def line_patrol():
    ...
    img.find_edges(image.EDGE_CANNY, threshold=canny_t)
    ...
    if (line):
        ...
        print(rho_err/5)
        print(w)
        ww=(line.x2()+line.x1())/2-img.width()/2
        print(ww/3)
        w = w+ww/3
        if w>=0:
